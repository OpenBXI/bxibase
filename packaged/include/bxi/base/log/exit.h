 ...
 * @brief  BXI Exit Module
 *
 * This module provides exit macros and functions that guarantees the flushing of
 * logs before exiting. They should be seen as replacement of the standard exit()
 * function.
 *
 */
