...
# -*- coding: utf-8 -*-
"""
@file report.py Defines reporting class to sort useful informations
...
@namespace bxi.base.report Python BXI Reporting

This module report information dedicated to the administrator.
The reporting is done by dispatching issues on different logger and ordering the issues.
"""
